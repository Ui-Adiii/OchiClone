...
const Insights = () => {
  return (
    <div className="pt-25 px-10 bg-[#1a1a1a] text-white min-h-screen flex justify-center items-center">
      <div className="max-w-6xl w-full">
        <h1 className="text-6xl font-bold uppercase tracking-tight text-center mb-7">Insights</h1>
        <div className="space-y-10">
          {insights.map((insight, index) => (
            <motion.div
              ...
              className="border-2 border-zinc-400 rounded-2xl p-4 hover:bg-zinc-800 transition-all"
            >
